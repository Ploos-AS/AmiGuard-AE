...
$(QUARANTINE_STORE_TEST_TARGET): tests/test_quarantine_store.c src/quarantine_store.c src/quarantine_model.c src/quarantine_model.h src/checksum.c src/checksum.h
	@mkdir -p build
