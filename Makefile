...
TARGET := AmiGuardAE
CORE_SOURCES := src/core.c src/arexx_dispatch.c src/scanner_bridge.c src/signature_bridge.c src/signature_manifest.c src/signature_auth_ed25519.c src/result_store.c src/checksum.c src/identify.c
...
$(TARGET): $(HOST_SOURCES) include/amiguard_ae.h src/arexx_dispatch.h src/arexx_amiga.h src/scanner_bridge.h src/signature_bridge.h src/signature_manifest.h src/signature_auth_ed25519.h src/result_store.h src/checksum.h src/identify.h
	$(HOST_CC) $(HOST_CFLAGS) $(HOST_SOURCES) -o $@

amiga:
	$(AMIGA_CC) $(AMIGA_CFLAGS) $(AMIGA_SOURCES) -o $(TARGET).amiga

$(TEST_TARGET): tests/test_dispatch.c $(CORE_SOURCES) include/amiguard_ae.h src/arexx_dispatch.h src/scanner_bridge.h src/signature_bridge.h src/result_store.h src/checksum.h src/identify.h
	@mkdir -p build
...
check: test
	...
	@echo "M3.8b host qualification: PASS"
